...
public:
	...
	myShader(std::string file_vertexshader, std::string file_geometryshader, std::string file_fragmentshader);
	...
	void setUniform(std::string name, std::vector<glm::fvec4>& input_array);
